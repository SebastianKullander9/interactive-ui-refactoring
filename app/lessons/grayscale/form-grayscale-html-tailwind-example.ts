export const formGrayscaleHtmlTailwindExample = `<div class="flex flex-col gap-8 w-full h-full bg-gray-100 p-16">
  <div class="flex justify-between items-center pb-6 border-b-2 border-y-gray-200">
    ...
    <div class="flex flex-row text-sm text-gray-900 items-center">
      <p>Bill monthly</p>
      <div class="w-10 h-6 rounded-full bg-indigo-500 p-1 mx-2">
  ...
  <div class="flex w-full justify-between gap-4">
    <form class="flex flex-col gap-4 w-full">
      ...
      ></input>
      <button class="bg-indigo-500 text-gray-50 p-4 rounded-md font-semibold">
        CREATE ACCOUNT
      </button>
    </form>

    <div class="flex flex-col gap-4 w-full">
      <div class="flex flex-col bg-white p-4 rounded-xl gap-4 border-2 border-indigo-300">
        <div class="flex justify-between">
          <p class="text-lg font-semibold text-gray-500">Small</p>
          <div class="w-7 h-7 bg-indigo-500 rounded-full flex items-center justify-center text-2xl font-bold text-white">&#10003;</div>
        </div>
        <div class="flex justify-between">
